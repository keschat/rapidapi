...
if [ "$1" = "--reset" ]; then
    ...
    rm -f ~/.rapidapi/first-run-complete
...
# export PORT=8443
export DB_URL="jdbc:mysql://localhost:3306/rapidapi?useSSL=false&serverTimezone=UTC&createDatabaseIfNotExist=true&allowPublicKeyRetrieval=true"
export DB_USER="root"
